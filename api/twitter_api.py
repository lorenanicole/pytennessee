...
class Twitter(object):
    ...
    def get_user_timeline(self, requested_time, user_id, screen_name):
        ...
        return [Tweet(requested_time=requested_time, **tweet) for tweet in json.loads(timeline_data.content)]