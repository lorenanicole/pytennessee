...
class Uber(object):
    ...
    def get_ride_arrival_time(self, request_id, starting_lat, starting_long, product_id=None):
        # /v1/estimates/time
        request_url = self.BASE_URL + "estimates/time?start_latitude={0}&start_longitude={1}".format(starting_lat, starting_long)
        ...
        return [UberTimeEstimate(request_id=request_id, starting_lat=starting_lat, starting_long=starting_long, **estimate) for estimate in json.loads(response_data).get("times")]

    def get_ride_duration_and_price(self, request_id, starting_lat, starting_long, ending_lat, ending_long, product=None):
        # /v1/estimates/price
        ...
        duration_ests = [UberDurationEstimate(request_id=request_id, starting_lat=starting_lat, starting_long=starting_long,
